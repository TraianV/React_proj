      ...
      <div className = {styles.profilePage}>
        ...
        <div className = {styles.profile}>
                  ...
                  <div className={styles.data}>                      
                    ...
                    <div >
                      <Link to="/myGames" style={{ color: 'inherit', textDecoration: 'inherit'}}><button>See your Games</button></Link>
                      <Link to="/borrowedGames" style={{ color: 'inherit', textDecoration: 'inherit'}}><button>See your borrowed Games</button></Link>
